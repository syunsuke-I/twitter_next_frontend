...
const SignUpForm = ({ isSignUpFormModalOpen,setIsSignUpFormModalOpen } : Props) => {
  ...
  return (
    <div className={` ${isSignUpFormModalOpen ? 'fixed inset-0 bg-gray-900 bg-opacity-50 z-10 flex items-center justify-center overflow-y-auto overflow-x-hidden top-0 right-0 left-0 w-full md:inset-0 h-[calc(100%-1rem)] max-h-full'  : 'flex items-center justify-center min-h-screen'}`}>
